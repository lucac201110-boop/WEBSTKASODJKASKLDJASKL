  ...
  return (
    <section id="home" className="relative flex min-h-screen items-center overflow-hidden pt-16">
      <div className="pointer-events-none absolute inset-0">
        ...
        <motion.div
          className="absolute -left-32 top-24 h-[420px] w-[420px] rounded-full bg-accent/20 blur-[90px] will-change-transform"
          animate={{ x: [0, 30, 0], y: [0, 20, 0] }}
          transition={{ duration: 14, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.div
          className="absolute -right-24 top-1/3 h-[380px] w-[380px] rounded-full bg-accent-secondary/20 blur-[90px] will-change-transform"
