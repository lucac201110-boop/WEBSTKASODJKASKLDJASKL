    ...
    <section id="faq" className="py-28">
      <div className="mx-auto max-w-2xl px-6">
        <SectionReveal className="mx-auto mb-14 max-w-xl text-center">
          <span className="font-mono text-[11px] uppercase tracking-[0.2em] text-accent">FAQ</span>
        ...
        <div className="space-y-3">
          {faqs.map((f, i) => {
            const isOpen = open === i;
            return (
              <SectionReveal key={f.question} delay={i * 0.05}>
                <div className="overflow-hidden rounded-xl border border-line bg-card">
                  ...
                  <AnimatePresence initial={false}>
                    {isOpen && (
                      ...
                      >
                        <p className="px-5 pb-4 text-[13.5px] leading-relaxed text-ink-secondary">
                          {f.answer}
                        </p>
                      </motion.div>
                    )}
