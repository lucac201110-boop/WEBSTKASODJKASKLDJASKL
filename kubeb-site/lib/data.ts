export const navLinks = [
  ...
  { label: "Mod Inspector", href: "/converter" },
...
// --- Converter page mock data ---
// Minecraft's classic 1.x.y numbering ran through 1.21.11 ("Mounts of
// Mayhem", released Dec 9, 2025) — the last release in that format — before
// switching to a year.drop scheme. 26.1 ("Tiny Takeover", Mar 2026) and 26.2
// ("Chaos Cubed", Jun 2026) followed; 26.2 is the latest stable release as
// of this build. Keep this list in sync as new drops ship.
export const converterVersions = ["1.20.1", "1.21", "1.21.1", "1.21.4", "1.21.11", "26.1", "26.2"];
