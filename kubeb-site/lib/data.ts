...
// Minecraft dropped the 1.21.x numbering in 2026 in favor of a year.drop
// scheme (announced Dec 2025). The 1.21.x line stopped at 1.21.4/1.21.5;
// there is no 1.21.11. As of this build the current releases are 26.1
// (Tiny Takeover, Mar 2026) and 26.2 (Chaos Cubed, Jun 2026) — 26.2 is the
// latest stable release. Keep this list in sync as new drops ship.
export const converterVersions = ["1.20.1", "1.21", "1.21.1", "1.21.4", "26.1", "26.2"];
